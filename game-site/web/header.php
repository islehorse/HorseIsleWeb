...
<meta http-equiv="pics-Label" content='(pics-1.1 "//www.icra.org/pics/vocabularyv03/" l gen true for "<?php echo("//".$host); ?>" r (n 0 s 0 v 0 l 0 oa 0 ob 0 oc 0 od 0 oe 0 of 0 og 0 oh 0 c 1)  gen true for "<?php echo($cfg["MAIN_DOMAIN"]); ?>" r (n 0 s 0 v 0 l 0 oa 0 ob 0 oc 0 od 0 oe 0 of 0 og 0 oh 0 c 1))' />
<style type="text/css">
hr {
height: 1;
color: #000000;
...
<?php
	if(is_logged_in())
	{
		...
		echo('<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=10><TR><TD><B><A HREF=/account.php>'.strtoupper($_SERVER['HTTP_HOST']).'</A><BR>Logged in as: '.htmlspecialchars($username).'<BR><A HREF=/?LOGOUT=1><img src=/web/but-logout.gif border=0></A><BR><A HREF='.$cfg["MAIN_DOMAIN"].'/><img src=/web/but-mainpage.gif border=0></A></TD><TD><BR><A HREF='.$cfg["MAIN_DOMAIN"].'/account.php><img src=/web/but-serverlist.gif border=0></A><BR><A HREF='.$cfg["MAIN_DOMAIN"].'/web/news.php><img src=/web/but-news.gif border=0></A><BR><A HREF='.$cfg["MAIN_DOMAIN"].'/web/forums.php><img src=/web/but-forums.gif border=0></A><BR><A HREF='.$cfg["MAIN_DOMAIN"].'/web/helpcenter.php><img src=/web/but-helpcenter.gif border=0></A></TD></TR></TABLE>');
	}
	else
	{
...
<TR><TD></TD><TD><INPUT TYPE=SUBMIT VALUE=LOGIN> (<A HREF='.$cfg["MAIN_DOMAIN"].'/web/forgotpass.php>Forgot?</A>)</TD></TR></FORM></TABLE>');
	}
